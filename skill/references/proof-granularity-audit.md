...
Use this checklist after the structural / Notion-math validator passes and before publishing a serious Chinese math lecture note.
...
9. Did the section reuse the named core example or explain why it is temporarily leaving that example?
...
- There is no example / non-example that would catch a wrong understanding of the assumptions.
...
- add or strengthen the named core example and reuse it through the proof;
